![jev-hooks — Ambient state for AI applications. React hooks or a backend-only program.](https://raw.githubusercontent.com/microchipgnu/jev-hooks/main/.github/assets/jev-hooks-header.png)
